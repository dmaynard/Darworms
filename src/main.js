...
DFA?B?AFC???E?A?D???????C???B?AFE??EDBEE?C??B?AE?D??B??DCB?CBBAX
DFA?B?AFC???E?A?D???????C???B?AFE??EDBEE?C??B?AE?D??B??DCC?CBBAX
DFACBBAFCBAFEBAEDDACAFDDCCFFBFAFEEDEDBDEECEEBBAEDDADBDADCBACBBAX


// Score 4 no wrapping
DFA?B??FC?????A?D???????C???B??FE??E???????????E?B?????D???CBBAX
  ...
  var applySettings = function() {
    ...
    if (darworms.dwsettings.backGroundTheme !== parseInt($('#backg').slider().val())) {
      ...
      if (darworms.theGame) {
        clearCanvas();
        drawCells();
        darworms.theGame.worms.forEach(function(worm, i) {
          worm.prevScore = 0; // to force redraw of score
        })
